...
global.gurl  =process.env.GURL  || "https://chat.whatsapp.com/DgDobmfNQPC8AwcgiRFlx6";
global.website=process.env.GURL || "https://chat.whatsapp.com/DgDobmfNQPC8AwcgiRFlx6" ; 
...
global.devs = "923007393724" // Developer Contact
global.sudo = process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : "923007393724";
global.owner= process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : "923007393724";
...
global.read_status_from =  process.env.READ_STATUS_FROM  ||  "923007393724,923xxxxxxxx";
...
module.exports = {
  ...
  caption : process.env.CAPTION || "『*ツ✮͢_⬖͠☞𝅉ᷩ𝅏ⷷ𝅉ⷷ𝅏ᷩ𝅉ᷲ𝅏𝅉ᷟ𝅏ᷴ𝅉ᷛ𝅏ⷩ𝅉ͣ𝅏ᷞ𓃮*』" , // ```『 ᴘᴏᴡᴇʀᴇᴅ ʙʏ ʜɪᴛᴅᴇᴠ²²¹-ᴍᴅ 』```", //*『sᴜʙsᴄʀɪʙᴇ • ʜɪᴛᴅᴇᴠ ᴛᴇᴄʜ』*\n youtube.com/@hitdeveloper0"),
 
  author : process.env.PACK_AUTHER|| "*ツ✮͢_⬖͠☞𝅉ᷩ𝅏ⷷ𝅉ⷷ𝅏ᷩ𝅉ᷲ𝅏𝅉ᷟ𝅏ᷴ𝅉ᷛ𝅏ⷩ𝅉ͣ𝅏ᷞ𓃮*",
  packname: process.env.PACK_NAME || "",
  botname : process.env.BOT_NAME  || "*ツ✮͢_⬖͠☞𝅉ᷩ𝅏ⷷ𝅉ⷷ𝅏ᷩ𝅉ᷲ𝅏𝅉ᷟ𝅏ᷴ𝅉ᷛ𝅏ⷩ𝅉ͣ𝅏ᷞ𓃮*",
  ownername:process.env.OWNER_NAME|| "*ツ✮͢_⬖͠☞𝅉ᷩ𝅏ⷷ𝅉ⷷ𝅏ᷩ𝅉ᷲ𝅏𝅉ᷟ𝅏ᷴ𝅉ᷛ𝅏ⷩ𝅉ͣ𝅏ᷞ𓃮*",
